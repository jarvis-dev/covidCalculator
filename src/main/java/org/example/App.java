...
public class App 
{
    public static void main( String[] args ) {
        ...
        increaseInCases=8*daysElapsed-300;   // Predicted rate of increase in cases w.r.t. time
        System.out.printf("The rate of increase in cases for today is :" +Math.round(increaseInCases));
        System.out.println();

        casesForToday=4*Math.pow(daysElapsed,2) - 300*daysElapsed + 7115; // Predicted increase in cases
        ...
        double z = 4*Math.pow(y,2) - 300*y + 7115; // Total predicted cases
